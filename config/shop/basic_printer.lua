...
BW.ShopPrinter("Improved", {
    ...
    mat = "phoenix_storms/white_brushes",
...
BW.ShopPrinter("Overclocked", {
    ...
    level=0,
    model = "models/props_lab/reciever01a.mdl",
    mat="models/props_wasteland/lighthouse_stairs",
...
BW.ShopPrinter("Diamond", {
    ...
    level=2,
    model = "models/props_lab/reciever01a.mdl",
    mat = "phoenix_storms/trains/track_beamtop",
...
BW.ShopPrinter("Blackhole", {
    ...
    level=3,
    model = "models/props_lab/reciever01b.mdl",
    mat="models/props_combine/masterinterface01c",
